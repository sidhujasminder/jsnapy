            ...
            if t in test_file:
                ...
                if test_file.get(t) is not None and (
                    ...
                    self.run_cmd(
                        ...
                        hostname,
                        db)
                    # Need to add len(test_file[t])>1, just for the case if we want to take only xml snapshot of
                    # of the rpc, without any other information about the test.
