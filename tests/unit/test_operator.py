...
class TestCheck(unittest.TestCase):
    ...
    def test_operator_define_operator_error_1(self,mock_error):
        op = Operator()
        op.no_failed = 0
        op.define_operator(self.hostname,'all-same','mock_xpath',['ele1'],'mock_err','mock_info','mock command',True,['mock_id'])
    ...
    def test_operator_exists_1(self, mock_error):
        with self.assertRaises(IndexError):
            op = Operator()
            op.exists('mock_path', [], 'mock_err','mock_info','mock_command',True,['mock_id'],'mock_xml1','mock_xml2')
            mock_error.assert_called()
    ...
    def test_operator_not_exists_1(self, mock_error):
        with self.assertRaises(IndexError):
            op = Operator()
            op.not_exists('mock_path', [], 'mock_err','mock_info','mock_command',True,['mock_id'],'mock_xml1','mock_xml2')
            mock_error.assert_called()
    ...
    def test_operator_all_same_1(self, mock_error):
        with self.assertRaises(IndexError):
            op = Operator()
            op.all_same('mock_path', [], 'mock_err', 'mock_info', 'mock_command', True, ['mock_id'], 'mock_xml1',
                          'mock_xml2')
            mock_error.assert_called()
    ...
    def test_operator_is_equal_1(self, mock_error):
        with self.assertRaises(Exception):
            op = Operator()
            op.is_equal('mock_path', [], 'mock_err', 'mock_info', 'mock_command', True, ['mock_id'], 'mock_xml1',
                        'mock_xml2')
            mock_error.assert_called()
    ...
    def test_operator_not_equal_1(self, mock_error):
        with self.assertRaises(Exception):
            op = Operator()
            op.not_equal('mock_path', [], 'mock_err', 'mock_info', 'mock_command', True, ['mock_id'], 'mock_xml1',
                        'mock_xml2')
            mock_error.assert_called()
    ...
    def test_operator_in_range_1(self, mock_error):
        with self.assertRaises(Exception):
            op = Operator()
            op.in_range('mock_path', [], 'mock_err', 'mock_info', 'mock_command', True, ['mock_id'], 'mock_xml1',
                        'mock_xml2')
            mock_error.assert_called()
    ...
    def test_operator_not_range_1(self, mock_error):
        with self.assertRaises(Exception):
            op = Operator()
            op.not_range('mock_path', [], 'mock_err', 'mock_info', 'mock_command', True, ['mock_id'], 'mock_xml1',
                        'mock_xml2')
            mock_error.assert_called()
    ...
    def test_operator_is_in_1(self, mock_error):
        with self.assertRaises(Exception):
            op = Operator()
            op.is_in('mock_path', [], 'mock_err', 'mock_info', 'mock_command', True, ['mock_id'], 'mock_xml1',
                        'mock_xml2')
            mock_error.assert_called()
    ...
    def test_operator_not_in_1(self, mock_error):
        with self.assertRaises(Exception):
            op = Operator()
            op.not_in('mock_path', [], 'mock_err', 'mock_info', 'mock_command', True, ['mock_id'], 'mock_xml1',
                     'mock_xml2')
            mock_error.assert_called()
    ...
    def test_operator_is_gt_1(self, mock_error):
        with self.assertRaises(Exception):
            op = Operator()
            op.is_gt('mock_path', [], 'mock_err', 'mock_info', 'mock_command', True, ['mock_id'], 'mock_xml1',
                      'mock_xml2')
            mock_error.assert_called()
    ...
    def test_operator_is_lt_1(self, mock_error):
        with self.assertRaises(Exception):
            op = Operator()
            op.is_lt('mock_path', [], 'mock_err', 'mock_info', 'mock_command', True, ['mock_id'], 'mock_xml1',
                      'mock_xml2')
            mock_error.assert_called()
    ...
    def test_operator_contains_1(self, mock_error):
        with self.assertRaises(Exception):
            op = Operator()
            op.contains('mock_path', [], 'mock_err', 'mock_info', 'mock_command', True, ['mock_id'], 'mock_xml1',
                      'mock_xml2')
            mock_error.assert_called()
    ...
    def test_operator_no_diff_1(self, mock_error, mock_xpath, mock_result):
        ...
        op = Operator()
        op.no_diff('mock_path', ['no node'], 'mock_err', 'mock_info', 'mock_command', True, ['mock_id'], 'mock_xml1',
                  'mock_xml2')
        mock_error.assert_called()
    ...
    def test_operator_no_diff_2(self, mock_error, mock_xpath, mock_print):
        ...
        op = Operator()
        op.no_diff('mock_path', ['mock_node'], 'mock_err', 'mock_info', 'mock_command', True, ['mock_id'], 'mock_xml1',
                   'mock_xml2')
        mock_error.assert_called()
    ...
    def test_operator_list_not_less_1(self, mock_xpath, mock_data, mock_print, mock_getnode, mock_printMessage):
        ...
        op = Operator()
        op.list_not_less('mock_path', ['no node'], 'mock_err', 'mock_info', 'mock_command', True, ['mock_id'], 'mock_xml1', 'mock_xml2')
